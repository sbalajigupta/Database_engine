...
/**
 * Below class has functions to 
 * update the database according to primary key
 */
public class UpdateData {
			...
			if (fileTemp.exists()) {
				...
				while (no_of_pages != 0) {
					...
					if (z1 == 13) {
						...
						int z3 = tableFile.readShort(); // start area or last
														// record
						int[] z4 = new int[z2];
	...
	/**
	 * Below method writes
	 *  the value given in command line 
	 *  into record
	 */
	...
	/**
	 *
	 * Below method calculates the 
	 *  address of the place to be
